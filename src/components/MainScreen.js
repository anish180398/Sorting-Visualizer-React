...
export default function MainScreen() {
    ...
    function checkSwappedElements(itemsPrev, itemsCurrent) {
        ...
        for (let i = 0; i < itemsCurrent.length; i++) {
            ...
            console.log(itemsCurrent[i]);
            console.log(itemsCurrent.length);
            console.log(itemsPrev[i]);
        ...
        <React.Fragment>
            ...
            <Container maxWidth="lg" style={{ height: '100vh' }}>
                <Grid container spacing={3}>
                    <Grid item xs={12}>
                        <Typography color="textSecondary" component="h3" variant="h3">Human Visual System for Sorting Algorithm
